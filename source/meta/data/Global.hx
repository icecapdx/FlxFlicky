...
class Global
{
    public static var spindashActive:Bool = true; // SET TO FALSE IF U DONT WANT THE SPINDASH AT ALL
    public static var dropDashActive:Bool = false; // SET TO FALSE IF U DONT WANT THE DROP DASH AT ALL
